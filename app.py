...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://doha:12345678@cloud.cwrbhkqwy2hu.us-east-1.rds.amazonaws.com/cloud?charset=utf8mb4'
db = SQLAlchemy(app)
sess = Session()
...
with app.app_context():
    my_conn = pymysql.connect(host='cloud.cwrbhkqwy2hu.us-east-1.rds.amazonaws.com', user='doha', password='12345678', db='cloud')
...
def get_db_connection():
    conn = sqlite3.connect(host='cloud.cwrbhkqwy2hu.us-east-1.rds.amazonaws.com', user='doha', password='12345678', db='cloud')
